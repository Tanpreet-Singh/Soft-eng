...
/**
 * The Threat objects which can be of type: Threat-Actor, Campaigns, Intrusion
 * Sets. These objects hold the values of individual threats within the JSON
 * files that have been parsed. These will be held in an array, and be used to
 * populate the database and manipulate GUI.
 * 
 * @author Vultures
 * @version 10/13/2021
 */
public class Threat {
	// all fields annotated "JsonProperty" are the attributes present within the
	// JSON file
	@JsonProperty("type")
	private String type;
	@JsonProperty("id")
	 ...
	 * 
	 * @param kill_chain_phases new ArrayList<KillChainPhase> to assign to
	 *                          kill_chain_phases field
	 */
	 ...
	 * 
	 * @param external_references new ArrayList<ExternalRef> to assign to
	 ...
	 * 
	 * @param x_mitre_platforms new ArrayList<String> to assign to x_mitre_platforms
	 *                          field
	 */
	...
	/**
	 * Print method for external_references field Nicely formats the Source Name,
	 * External ID, and URL of all external references in a Threat Object
	 * 
	 */
	...
	/**
	 * Print method for kill_chain_phases field Nicely formats the Kill-Chain-Phase,
	 * and Phase Name of all kill_chain_phases in a Threat Object
	 * 
	 */
